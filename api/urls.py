...
from .views import (RegisterUserView,LoginView,UserProfileView,AddRecipeView,
                    ...
                    UserPreferenceListView,FilteredAllRecipeListView,LikedRecipesView,
                    UserPreferenceDeleteView,UserPreferencePartialUpdateView,RecipeSimilarityView,
                    UpdateRecipeView,AllPreferencesListView,RecipeByMajorIngredientView,FilteredRecipeListView,
                    CuisineListView,CourseListView,DietaryRestrictionListView,
